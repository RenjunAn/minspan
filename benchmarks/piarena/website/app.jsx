...
const DEFENSE_DOC_ORDER = ['none', 'pisanitizer', 'secalign', 'datasentinel', 'attentiontracker', 'promptguard', 'promptlocate', 'promptarmor', 'datafilter', 'piguard', 'deepseek-pisanitizer', 'modernbert-tagger'];
const DOC_REDIRECTS = {
