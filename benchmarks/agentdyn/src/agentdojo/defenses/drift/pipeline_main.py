import time
from client import DeepSeekModel, GoogleModel, OpenAIModel, OpenRouterModel
...
def main(args, suite_type):
    ...
    if model_name.startswith("gpt-"):
        ...
        client = DeepSeekModel(model=args.model, logger=logger)
        tools_pipeline_name = args.model
        logger.info(f"Using DeepSeek Client: {args.model}")
